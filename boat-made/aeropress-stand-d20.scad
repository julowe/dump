use <PolyDiceGenerator/PolyDiceGenerator.scad>;

//aeropress stand - wide free-floating base vs fletcher design

//diff file for d20 bc needs library

rough_render = 15;
smooooth_render = 180;
$fn = smooooth_render; //resolution of curves

//TODO remove magnet voids
//TODO change grippy feet depth?
...
d12_height = 129.17; //FYI 129.17 is exactly right to make a nice clean point where faces meet at top of dice and the void for pluger to slide into
d20_height = 60;  //60 is close to the minimum so grippy feet stay inside walls. 77 is decent height
...
//    //or make half a d12!!
//    dodecahedron(d12_height);
//    translate([-d12_height,-d12_height,-d12_height]){
//        cube([d12_height*2,d12_height*2,d12_height]);
//    }
    translate([0,0,-d20_height]){
        rotate([0,0,-21]){
            drawd20(d20_size=d20_height*2);
        }
    }
    translate([-d20_height*2,-d20_height*2,-d20_height-1]){
        cube([d20_height*4,d20_height*4,d20_height+1]);
    }
    ...
    translate([-plunger_tube_diameter/2,0,-0.1]){
        cube([plunger_tube_diameter,plunger_tube_diameter*3,plunger_nominal_height]);
    }
